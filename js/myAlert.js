function myAlert(str,click,useCancel){
    ...
    var init=function(){
        ...
        var $myalert = $("<div style='width:60%;position:absolute;top:30%;left:50%;margin-left:-30%;padding:.2rem;padding-bottom:.1rem;background:rgb(36,55,74);border-radius:.05rem;'>"+
            "</div>")
            .appendTo($hidder);
        $("<div style='padding:.1rem 0 .15rem 0;color:rgb(239,103,103);border-bottom:1px solid rgba(255,255,255,.2);line-height: .25rem;'>"+str+"</div>").appendTo($myalert);
        var $myalert_btn_div = $("<div style='padding-top:.08rem;'></div>").appendTo($myalert);
        var $okBtn = $("<div style='float:left;width:100%;color:rgb(0,155,219);border-radius:2px;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;' class='bluebg1'>确定</div>")
